...
<html lang="en">
    ...
    <body class="flex flex-col items-center bg-gradient-to-t from-green-900 to-green-400 overflow-y-hidden">
        ...
        <div class="flex flex-col bg-gradient-to-t from-green-400 to-green-900 rounded-xl p-3 w-3/5 mt-10 mb-10">
