...
<body class="flex flex-col items-center bg-gradient-to-t from-green-900 to-green-400">
    ...
    <div class="flex flex-col bg-gradient-to-t from-green-400 to-green-900 rounded-xl w-3/5 mb-20 p-3"> <!-- COOL FORM BORDER -->
        <form class="flex flex-col bg-green-300 w-full items-center h-auto rounded-xl" action="http://172.31.109.60:6969/api/register" method="POST">

            <!-- The WELCOME banner above the form -->
            <div class="flex flex-col items-center bg-green-100 w-3/5 items-center mt-4 p-4 mb-10 rounded-xl">
